...
class CrmLeadReportWizard(models.TransientModel):
    ...
    x_dealer_id = fields.Many2one('res.users', string="Dealer", default=lambda self: self.env.user, readonly=True)
    x_branch_id = fields.Many2one('res.company', string="Branch", default=lambda self: self.env.company, readonly=True)
