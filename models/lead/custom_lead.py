...
class CustomLead(models.Model):
    ...
    x_request_sale_3rd_barrels_id = fields.Many2one('third.party.registration', string='Proposal to sell in Encroaching area/Third party/Body maker', readonly=True, tracking=True)
